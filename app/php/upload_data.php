...
if (move_uploaded_file($_FILES["audioname"]["tmp_name"], $target_file)) {
    ...
    } //shouldn't need an else here todo update album art

    /* Insert data */
//        $sql = "INSERT INTO Data (filename,title, user_id, artist_id, album_id) VALUES ('$filename','$title','0','$artist_id','$album_id')";
//
//
