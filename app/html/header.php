    ...
    <div id="primary-menu-offcanvas" class="off-canvas off-canvas-left d-flex flex-column">
        <div class="m-3">
            <a class="close-offcanvas-main-menu" href="#" data-target="#primary-menu-offcanvas"><span
                        class="adonis-icon icon-5x"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" height="20"
...
" width="1" height="1">
                ...
                <!--                    <div>-->
                <!--                        <a class="nav-link" id="btn-search-4" href="#"><span class="adonis-icon icon-3x"><svg-->
                ...
                <!--                                                        viewBox="0 0 32 32"><path-->
                <!--                                                            d="M30 19l-9 9-3-3-2 2 5 5 11-11z"></path><path-->
                ...
                <!--                                                            d="M0 0h24v24H0z" fill="none"/></svg></span>Purchased</a>-->
                <!--                                    </li>-->
                <!--                                    <li><a href="#" class="inactive-color"><span class="adonis-icon mr-3 icon-2x"><svg-->
                <!--                                                        version="1.1" xmlns="http://www.w3.org/2000/svg" height="32"-->
                <!--                                                        viewBox="0 0 32 32"><path-->
