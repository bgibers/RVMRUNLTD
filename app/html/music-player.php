                    ...
                    <div class="row adonis-player pt-3 pb-xxl-3 flex-nowrap justify-content-xxl-start justify-content-between">
                        <div class="col-sm-6 col-md-4 col-xxl-2 d-none d-sm-block">
                            <div class="media current-item">
                                ...
                                <div class="des">
                                    ...
                                    <div class="artist-name inactive-color"><a href="#" class="inactive-color">Pentatonix</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-auto col-xl-auto col-lg-4 d-flex align-items-center">
                            ...
                            <div class="m-auto d-flex flex-row lh-0 player-controls fs-3 align-items-center">
                                <a class="jp-shuffle inactive-color mr-2 d-none d-md-block" role="button"
                                   tabindex="0"><span class="adonis-icon icon-2x"><svg version="1.1"
                                ...
                                <a class="jp-repeat inactive-color ml-2 d-none d-md-block" role="button"
                                   tabindex="0"><span class="adonis-icon icon-3x"><svg version="1.1"
                                                                                       xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="col-auto d-flex align-items-center justify-content-end pl-0">
                            <div class="mr-2"><a class="toggle-off-canvas" data-target="#adonis-playlist"
                                                 tabindex="0"><span class="adonis-icon icon-4x"><svg version="1.1"
                                                                                                     xmlns="http://www.w3.org/2000/svg"
                                                                                                     height="13"
                            ...
                            <div class="jp-volume-controls flex-row align-items-center ml-3 mr-4 d-none d-xl-flex">
                                <a class="mr-3 adonis-mute-control" role="button" tabindex="0"><span
                                            class="adonis-icon icon-3x"><svg version="1.1"
                                                                             xmlns="http://www.w3.org/2000/svg"
                                                                             height="13" viewBox="0 0 48 32"><path
                            ...
                            <div class="align-items-center d-flex lh-0">
                                <a href="#" class="pl-2 pr-2 d-inline-block fs-2 inactive-color"><span
                                            class="adonis-icon icon-2x"><svg xmlns="http://www.w3.org/2000/svg"
                                                                             version="1.1"><use
                                                    xlink:href="#icon-heart-blank"></use></svg></span></a>
                                <a href="#" class="pl-2 pr-2 d-inline-block inactive-color current-track-menu"><span
                                            class="adonis-icon icon-1x"><svg version="1.1"
                                                                             xmlns="http://www.w3.org/2000/svg"
                                                                             height="22" viewBox="0 0 6 32"><path
                        ...
                        <div class="player-details col-8 pr-0 pl-20 pl-e-lg-30">
                            ...
                            <div class="controls d-flex flex-row justify-content-between">
                                ...
                                <div class="lh-0 align-items-center d-flex">
                                    <a href="#" class="inactive-color fs-3"><span class="adonis-icon icon-2x"><svg
                                                    xmlns="http://www.w3.org/2000/svg" version="1.1"><use
                                                        xlink:href="#icon-heart-blank"></use></svg></span></a>
                                    <a href="#" class="inactive-color ml-3 current-track-menu"><span
                                                class="adonis-icon icon-5x"><svg version="1.1"
                                                                                 xmlns="http://www.w3.org/2000/svg"
                                                                                 height="26" viewBox="0 0 32 32"><path
                    ...
                    <div class="d-flex fs-1 mt-3 media align-items-center controls">
                        <div class="lh-0 d-flex playlist-player-control justify-content-between align-items-center col-4 p-0 ">
                            ...
                            <a class="jp-play fs-4" role="button" tabindex="0">
                                <span class="adonis-icon icon-play icon-2x"><svg version="1.1"
                                                                                 xmlns="http://www.w3.org/2000/svg"
                                                                                 height="19" viewBox="0 0 29 32"><path
                                                d="M27.703 14.461l-24.945-14.187c-0.272-0.174-0.604-0.278-0.96-0.278-0.993 0-1.798 0.805-1.798 1.798 0 0.001 0 0.002 0 0.004v-0 28.434c0.004 0.982 0.801 1.776 1.783 1.776 0.338 0 0.653-0.094 0.922-0.257l-0.008 0.004c1.524-0.869 23.65-13.44 25.006-14.217 0.549-0.303 0.914-0.878 0.914-1.539s-0.366-1.236-0.905-1.534l-0.009-0.005z"></path></svg></span>
                                <span class="adonis-icon icon-pause icon-2x"><svg version="1.1"
                                                                                  xmlns="http://www.w3.org/2000/svg"
                                                                                  height="19" viewBox="0 0 29 32"><path
